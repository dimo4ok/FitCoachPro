...
{
    /// <inheritdoc />
    public partial class AddTemplateWorkoutEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "CoachId",
                table: "TemplateWorkoutItems",
                newName: "TemplateWorkoutPlanId");

            migrationBuilder.RenameIndex(
                name: "IX_TemplateWorkoutItems_CoachId",
                table: "TemplateWorkoutItems",
                newName: "IX_TemplateWorkoutItems_TemplateWorkoutPlanId");

            migrationBuilder.CreateTable(
                name: "TemplateWorkoutPlans",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplateWorkoutPlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TemplateWorkoutPlans_Users_CoachId",
                        column: x => x.CoachId,
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_TemplateWorkoutItems_TemplateWorkoutPlans_TemplateWorkoutPlanId",
                table: "TemplateWorkoutItems",
                column: "TemplateWorkoutPlanId",
                principalTable: "TemplateWorkoutPlans",
                principalColumn: "Id",
                onDelete: ReferentialAction.Cascade);
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "TemplateWorkoutPlanId",
                table: "TemplateWorkoutItems",
                newName: "CoachId");

            migrationBuilder.RenameIndex(
                name: "IX_TemplateWorkoutItems_TemplateWorkoutPlanId",
                table: "TemplateWorkoutItems",
                newName: "IX_TemplateWorkoutItems_CoachId");
