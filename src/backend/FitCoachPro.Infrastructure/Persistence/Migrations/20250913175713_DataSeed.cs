...
namespace FitCoachPro.Infrastructure.Migrations
{
    ...
    public partial class DataSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DateOfExpiredSubscription", "DateOfRegistration", "FirstName", "LastName", "PasswordHash", "Role", "TelephoneNumber" },
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), null, new DateTime(2025, 7, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "John", "Doe", "hash1", 0, "+123456789" },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, new DateTime(2025, 7, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Anna", "Smith", "hash2", 0, "+987654321" },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 7, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mike", "Johnson", "hash3", 0, "+192837465" }
                });

            migrationBuilder.InsertData(
                table: "WorkoutPlans",
                columns: new[] { "Id", "DateOfDoing", "UserId" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 7, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa") },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2025, 7, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb") },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2025, 7, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc") }
                });
