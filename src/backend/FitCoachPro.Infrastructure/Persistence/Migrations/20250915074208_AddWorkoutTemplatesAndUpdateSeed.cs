...
{
    /// <inheritdoc />
    public partial class AddWorkoutTemplatesAndUpdateSeed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaa0000-0000-0000-0000-000000000001"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), new DateTime(2025, 9, 14, 0, 0, 0, 0, DateTimeKind.Utc), null },
                    { new Guid("aaaa0000-0000-0000-0000-000000000002"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), new DateTime(2025, 9, 14, 0, 0, 0, 0, DateTimeKind.Utc), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-0000-0000-0000-000000000001"), "3 sets of 15 reps", new Guid("aaaaaaaa-1111-1111-1111-111111111111"), new Guid("aaaa0000-0000-0000-0000-000000000001") },
                    { new Guid("11111111-0000-0000-0000-000000000002"), "3 sets of 20 reps", new Guid("bbbbbbbb-2222-2222-2222-222222222222"), new Guid("aaaa0000-0000-0000-0000-000000000001") },
                    { new Guid("22222222-0000-0000-0000-000000000003"), "Hold for 60 seconds", new Guid("cccccccc-3333-3333-3333-333333333333"), new Guid("aaaa0000-0000-0000-0000-000000000002") },
                    { new Guid("22222222-0000-0000-0000-000000000004"), "3 sets of 10 reps per leg", new Guid("dddddddd-4444-4444-4444-444444444444"), new Guid("aaaa0000-0000-0000-0000-000000000002") }
                });
